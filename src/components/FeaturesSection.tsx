...
const features = [
  {
    ...
    title: "Studio Setup",
    desc: "High-end microfoons en akoestische ruimte.",
  },
  {
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Professionele opnames vanuit meerdere hoeken.",
  },
  {
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Lighting & sfeer",
    desc: "Cinematic belichting voor premium uitstraling.",
  },
  {
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Klaar om te publiceren, snel geleverd.",
  },
];
        ...
        <div className="mt-20 grid gap-8 sm:grid-cols-2 xl:grid-cols-4">
          {features.map((f, i) => (
            ...
            >
              ...
              <p className="mt-3 text-[#B3B3B3] leading-relaxed">{f.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
